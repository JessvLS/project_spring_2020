...
Everything below was taken from the original README file (updated README following the completion of our package will be found within the project_spring_2020 folder):
